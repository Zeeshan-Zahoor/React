...
function Card({cardTitle, btnText = "Get Started..!!"}) {
    "use client";
      const [isHovered, setIsHovered] = useState(false);
    return (
        <div
        className="p-1 shadow-2xl bg-white border border-zinc-800 hover:border-white rounded-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 cursor-pointer mb-5"
